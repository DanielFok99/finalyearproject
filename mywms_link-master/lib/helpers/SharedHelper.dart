...
// class SharedHelper{
//   //创建工厂方法
//   static SharedHelper? _instance;
//   factory SharedHelper() => _instance ??= SharedHelper._initial();
//   SharedPreferences? _preferences;
//   //创建命名构造函数
//   SharedHelper._initial() {
...
//   static Future<SharedHelper?> perInit() async {
//     if (_instance == null) {
//       //静态方法不能访问非静态变量所以需要创建变量再通过方法赋值回去
//       SharedPreferences preferences = await SharedPreferences.getInstance();
//       _instance = SharedHelper._pre(preferences);
//     }
//     return _instance;
//   }
//   SharedHelper._pre(SharedPreferences prefs) {
//     _preferences = prefs;
//   }
//   ///设置String类型的

    ...
    <form class="validate-form" @submit.prevent="submit">
      <ModalBody class="p-0">
        <div class="p-5 text-center">
          ...
          <div class="text-slate-500 mt-2" v-if="group!= null && group.is_default !== true">
            Do you really want to delete these records? <br />This
            process cannot be undone.
          </div>
          <div class="text-slate-500 mt-2" v-else>
            Default group can't be delete
          </div>
        ...
        <div class="px-5 pb-8 text-center">
          ...
          <button v-if="group!= null && group.is_default !== true" type="submit" class="btn btn-danger w-24">
            Delete
          </button>
        </div>
      </ModalBody>
...
const submit = () => {
  web.delete('/customer-groups/'+ props.group.id).then((response) => {
